...
def visualize_author_graph(G, seed=1472, k=5, iterations=500):
    ...
    nx.draw_networkx_edges(G, pos, edge_color=edge_colors, width=edge_widths, alpha=0.4, connectionstyle='arc3,rad=0.2')
    ...
    plt.axis('off')
    plt.title("Author Co-Authorship Network", fontsize=14)
    plt.tight_layout()
    plt.show()